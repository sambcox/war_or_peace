class Turn
  ...
  def type
    unless player1.deck.cards[0].rank == player2.deck.cards[0].rank
      :basic
    else
      if player1.deck.cards[2] && player2.deck.cards[2] && player1.deck.cards[2].rank == player2.deck.cards[2].rank
